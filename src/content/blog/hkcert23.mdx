...
> Web: http://stcode-3983gi.hkcert23.pwnable.hk:28211 > **Note**: There is a guide for this challenge [here](https://hackmd.io/@blackb6a/hkcert-ctf-2023-ii-en-4e6150a89a1ff32c#ST%E7%A2%BC-I--ST-Code-I-Misc).

:::success
Code used in this solution (and for ST Code II) can be found [on GitHub](https://github.com/sportshead/hkcert23-stcode).
:::

<div class="font-regular bg-blue-500 text-white relative mb-4 block w-full rounded-lg p-4 text-base leading-5 opacity-100">
